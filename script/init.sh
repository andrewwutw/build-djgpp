...
prepend BINUTILS_CONFIGURE_OPTIONS "$GLOBAL_CONFIGURE_OPTIONS"
prepend   NEWLIB_CONFIGURE_OPTIONS "$GLOBAL_CONFIGURE_OPTIONS"
prepend  AVRLIBC_CONFIGURE_OPTIONS "$GLOBAL_CONFIGURE_OPTIONS"
