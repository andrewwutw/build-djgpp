...
DJCRX_ARCHIVE="http://ap1.pp.fi/djgpp/djdev/djgpp/20140421/djcrx${DJCRX_VERSION}.zip"
DJLSR_ARCHIVE="http://ap1.pp.fi/djgpp/djdev/djgpp/20140421/djlsr${DJLSR_VERSION}.zip"
...
(
  ...
  if [ -f bin/i586-pc-msdosdjgpp-gcc ]; then
    cp bin/i586-pc-msdosdjgpp-gcc i586-pc-msdosdjgpp/bin/gcc
  fi
  if [ -f bin/i586-pc-msdosdjgpp-g++ ]; then
    cp bin/i586-pc-msdosdjgpp-g++ i586-pc-msdosdjgpp/bin/g++
  fi
  if [ -f bin/i586-pc-msdosdjgpp-c++ ]; then
    cp bin/i586-pc-msdosdjgpp-c++ i586-pc-msdosdjgpp/bin/c++
  fi
) || exit 1
